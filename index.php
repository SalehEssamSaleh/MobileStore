          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <?php
                  if(isset($_SESSION['user'])) {
                    echo '<a class="nav-link" aria-current="page" href="ask.php">Ask</a>';
                  }
                ?>
              </li>
              ...
              <li class="nav-item">
                <?php
                  if(isset($_SESSION['user'])) {
                    echo '<a class="nav-link" aria-current="page" href="the-answer.php">The Answers</a>';
                  }
                ?>
              </li>
        ...
        <div class="row">
          <?php
            ...
            while($res=mysqli_fetch_assoc($ret)){
              ...
              /*<button href="" class="btn btn-danger">Mobile Description</button>*/
          ?>
        <!-- <div class="row">
          <div class="col-lg-4 col-sm-12">
            <center class="thumbnil">
        ...
        <div class="container">
          <div class="col-lg-6">
            ...
            <form class="text-light" action="" method="post">
              ...
              <!-- 
              JavaScript Trick " To change image when the mouse over and the mouse out also "
                <a href="https://www.linkedin.com/in/saleh-essam-saleh/" onMouseOver="button.src='img/arrow.png';" onMouseOut="button.src='img/sample.png';">
                  <img src="img/login.png" style="width:15%; height:auto;" name="button">
                </a> 
              -->
