          ...
          <div class="col-lg-12 col-md-12">
            <form action="" method="post">
                <div class="mb-3">
                  ...
                  <input type="text" name="full_name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Your Full Name ...">
                </div>
                <div class="mb-3">
                  <label for="exampleInputPassword1" class="form-label">Email</label>
                  <input type="email" name="email" class="form-control" id="exampleInputPassword1" placeholder="Enter Your Email here ...">
                </div>
                <div class="mb-3">
                  <label for="exampleInputPassword1" class="form-label">User Name</label>
                  <input type="text" name="user_name" class="form-control" id="exampleInputPassword1" placeholder="Enter Your User Name here ...">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="password" name="password_confirmation" class="form-control" id="exampleInputPassword1" placeholder="Enter The Same Password here Again...">
                </div>
                      ...
                      if($password == $password_confirmation) {
                        ...
                        $ret = mysqli_query($connection, $sql);
                          if($ret) 
                            ...
                            echo '<p>Sorry Passwords are not Matching, Try again please...</p>';
                          }
                      }
