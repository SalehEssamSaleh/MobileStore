        ...
        <div class="row">
          <div class="col-lg-12 col-md-12">
            <center>
              <h3>
                <b>
                  Please <span class="text-danger">Register</span>
                  <br>
                  First to view This
                  <br>
                  <span class="text-primary">MOBILE DETAILS</span>
                </b>
                <hr style="width:25%;">
              </h3>
              <!-- <a type="button" href="mobile-detials.php?id=<?php /*echo $res['id']*/ ?>" class="btn btn-primary">Login</a> -->
              <img src="img\login.png" style="height:auto; width:35%;" alt="">
            </center>
          </div>
        </div>
      </div>
            ...
            <form class="text-light" action="" method="post">
              ...
              <?php
                if(isset($_POST['signin'])) {
                  ...
                  echo '<br><br><p class="text-warning"><b>Sorry either User or Password is not correct</b></p>';
                }
              ?>
            </form>
          </div>
