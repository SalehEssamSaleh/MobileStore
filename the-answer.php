<?php
  ...
  $sql = "select * from question where user_name='$user_name'";
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="container">
        <br>
        <center>
          <h1 class="fw-bold">The Question Answers</h1>
          <hr style="width:25%;">
        </center>
        <br><br>
        <div class="row">
          <div class="col-lg-12 col-md-12">
            <form action="" method="post">
                ...
                <div class="mb-3">
                  <h2 class="fw-bold text-primary">The Question :</h2>
                  <hr style="width:19%;">
                  <h5>
                    <?php echo $question; ?>
                  </h5>
              ...
              <br>
                <div class="mb-3">
                  <h2 class="fw-bold text-success">The Answer :</h2>
                  <hr style="width:19%;">
                  <h5>
                    <?php echo $answer; ?>
                  </h5>
