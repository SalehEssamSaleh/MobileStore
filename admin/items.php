...
<html lang="en">
  <head>
    ...
    <title>All Mobiles In the Store</title>
          ...
          <div class="col-lg-12 col-md-12">
              ...
              <table class="table table-striped table-dark table-bordered border-warning align-middle text-center">
                  ...
                  <?php
                    ...
                    ?>
                    <td>
                      <a type="button" href="edit-product.php?id=<?php echo $res['id'] ?>" class="btn btn-primary">Edit</a>
                    </td>
                    <td>
                      <a type="button" href="delete-product.php?id=<?php echo $res['id'] ?>" class="btn btn-danger">Delete</a>
                    </td>
                    <?php
                          echo '</tr>';
                    }
