        ...
        <div class="row">
          <div class="col-lg-12 col-md-12">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <h2 class="fw-bold">The Question</h2>
                    <br>
                ...
                <div class="mb-3">
                <h2 class="fw-bold">
                    <label for="exampleInputPassword1" class="form-label">The Answer</label>
                </h2>
                    <textarea name="answer" class="form-control" id="exampleInputPassword1"></textarea>
                </div>
                ...
                <input type="submit" name="answer-button" value="Answer this Question" class="btn btn-warning fw-bold float-end">

                <?php
                
                if(isset($_POST['answer-button'])) {
                  $answer = $_POST['answer'];
                  $sql = "update question set user_name='$user_name' , question = '$question' , answer = '$answer' where id='$id'";                  
                  $ret = mysqli_query($connection, $sql);
                    if($ret) 
                    echo '<p>The Question has been answered</p>';
                }
