        ...
        <div class="row">
          <div class="col-lg-12 col-md-12">
            <form action="" method="post">
                <div class="mb-3">
                  <label for="exampleInputEmail1" class="form-label fw-bolder">Leave your Question</label>
                  <textarea name="question" class="form-control" id="exampleInputEmail1" ></textarea>
                </div>
                
                <input type="submit" name="ask" value="Ask Now" class="btn btn-warning fw-bolder float-end">
                ...
                <?php
                  if(isset($_POST['ask'])) {
                      ...
                      $ask = $_POST['question'];
                        ...
                        $sql = "insert into question(user_name,question) values ('$user_name','$ask')";
                        $ret = mysqli_query($connection, $sql);
                          if($ret) 
                            echo '<p>Your question has been asked, and we are waiting for an answer from the site administrators soon</p>';
                          }
                ?>
